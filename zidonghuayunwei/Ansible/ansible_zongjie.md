...
### 运维自动化发展历程及技术应用
![image-20220308113115986](ansible_zongjie.assets/image-20220308113115986.png)
...
### 运维自动化发展历程及技术应用
![image-20220308113138667](ansible_zongjie.assets/image-20220308113138667.png)
...
```
![image-20220308113200584](ansible_zongjie.assets/image-20220308113200584.png)
...
### Ansible架构
![image-20220308113217319](ansible_zongjie.assets/image-20220308113217319.png)
```
ansible的作用以及工作结构
1、ansible简介：
...
```
### Ansible工作原理
![image-20220308113236516](ansible_zongjie.assets/image-20220308113236516.png)
...
```
### playbook图解
![image-20220308113312920](ansible_zongjie.assets/image-20220308113312920.png)
```
...
### 三种常见的数据交换格式
![image-20220308113331025](ansible_zongjie.assets/image-20220308113331025.png)
...
- hosts: srv120
  ...
  tasks:
    - name:
      ...
      when: ansible_distribution_major_version == "7"
```
![image-20220308113436096](ansible_zongjie.assets/image-20220308113436096.png)
### 迭代：with_items
```
...
### Ansible Roles目录编排
![image-20220308113504581](ansible_zongjie.assets/image-20220308113504581.png)
...
### Roles案例
Roles目录编排    
![image-20220308113534046](ansible_zongjie.assets/image-20220308113534046.png)

Playbook中调用     
![image-20220308113545253](ansible_zongjie.assets/image-20220308113545253.png)
